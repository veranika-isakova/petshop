...
cat3 = Pet.create!(name: "Rayta", species: "Cat", gender: "Female", age: 1, price: 399, remote_image_url: "http://res.cloudinary.com/teateearu/image/upload/c_fill,h_200,w_242/v1510909475/Young_Male_CFA_Kitten_-_Age_2_Months_kjbzkz.jpg", category: cats)

dog1 = Pet.create!(name: "Tea", species: "Dog", gender: "Female", age: 2, price: 150, remote_image_url: "http://res.cloudinary.com/teateearu/image/upload/c_scale,w_242/v1510909968/slack-imgs.com_aiz0x5.jpg", category: dogs)
dog2 = Pet.create!(name: "Henock", species: "Dog", gender: "Male", age: 8, price: 800, remote_image_url: "http://res.cloudinary.com/teateearu/image/upload/c_scale,w_242/v1510917796/istock_000017819430_small_fgzx1c.jpg", category: dogs)
